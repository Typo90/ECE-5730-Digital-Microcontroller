...
//#define BEEP_DURATION           760
#define BEEP_DURATION           680
#define pulse_time 80
//#define BEEP_REPEAT_INTERVAL    40000
#define BEEP_REPEAT_INTERVAL    10400
...
volatile unsigned int pause_flag_0 = 0 ; 
volatile unsigned int pause_flag_1 = 0 ; 
// SPI data
...
#define PIN_MISO 4
#define PIN_CS   5 //yes
#define PIN_SCK  6 //yes
#define PIN_MOSI 7 //yes
#define LDAC     8 //yes
#define LED      25
...
bool repeating_timer_callback_core_0(struct repeating_timer *t) {
    ...
    if(pause_flag_1 == 0){
        ...
        // State transition?
            ...
            count_0 = count_0 + 1 + count_0_incre;
